...
p1 <- summaryPaperInc %>%
  ...
  scale_fill_manual(values = c("#C19EAB", "#C19EAB", "#8B475D")) +
  theme_minimal() +
  labs(y = "Total number of papers x country", x = "Income group") +
  theme(legend.position = "none") +
...
p2 <- summarySurveysInc %>%
  ...
  theme_minimal() +
  labs(y = "Total number of survey items x country x year", x = "Income group") +
  theme(legend.position = "none") +
  expand_limits(y = max(totals$total) * 1.05)  # avoid clipping
...
p3 <- summaryPaperExp %>%
  ...
  theme_minimal() +
  labs(y = "Total number of papers x country", x = "Pollution exposure") +
...
p3 <- p3 + theme(axis.text.x=element_text(size = 8))
...
p4 <- summarySurveysExp %>%
  ...
  theme_minimal() +
  labs(y = "Total number of survey items x country x year", x = "Pollution exposure") +
  theme(legend.position = "none", axis.text.x = element_text(size = 7)) +
  expand_limits(y = max(totals$total) * 1.05)  # avoid clipping
...
p2 <- summarySurveysInc %>%
  ...
  theme_minimal() +
  labs(y = "Total number of survey\nitems x country x year", x = "Income group") +
  theme(legend.position = "none") +
  expand_limits(y = max(totals$total) * 1.05)  # avoid clipping
...
p4 <- summarySurveysExp %>%
  ...
  scale_fill_manual(values = c("#E6D0F4", "#B873E7")) +
  theme_minimal() +
  labs(y = "Total number of survey\nitems x country x year", x = "Pollution exposure") +
  theme(legend.position = "none", axis.text.x = element_text(size = 7)) +
  expand_limits(y = max(totals$total) * 1.05)  # avoid clipping
