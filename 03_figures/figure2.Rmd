...
p1 <- ggplot(papers_long, aes(y = reorder(Topic, n), x = n, fill = Topic)) +
  ...
  geom_text(aes(label = percent(share, accuracy = 1)),
            hjust = -0.3, size = 5) +
  labs(y = NULL, x = "Number of papers x country covering topic") +
...
p2 <- ggplot(surveys_long, aes(y = reorder(Topic, n), x = n, fill = Topic)) +
  ...
  geom_text(aes(label = percent(share, accuracy = 1)),
            hjust = -0.3, size = 5) +
  labs(y = NULL, x = "Number of survey items x country\nx year covering topic") +
  scale_fill_manual(values = c(
    "Perceptions" = "#8B7B8B",
    "Behavior"    = "#EED8AE",
    "Priority"    = "#CDB5CD",
...
p4 <- ggplot() +
  ...
  geom_tile(data = surveys_totals,
            aes(x = Income.group, y = "Total items x\ncountry x year", fill = total),
            color = "white", linewidth = 0.8) +
  geom_text(
    data = surveys_totals,
    aes(x = Income.group, y = "Total items x\ncountry x year",
...
p6 <- ggplot() +
  ...
  geom_tile(
    ...
    aes(x = categoryPollution, y = "Total items x\ncountry x year", fill = total),
    color = "white", linewidth = 0.8
  ) +
  geom_text(
    data = totals_data_survey_poll,
